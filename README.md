...
> This is a React Js based web application for creating events in Snapchat
...
- open a terminal
- run ``` git clone git@github.com:mr-abdellah/snapchat-event.git```
- run ``` cd snapchat-event```
